        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center py-8 px-4 sm:p-12 lg:px-24 xl:px-32 relative bg-gradient-to-br from-white to-gray-50 order-1" style="view-transition-name: auth-panel;">
            ...
            <div class="w-full max-w-md mx-auto relative z-10">
                ...
                <div class="mb-8 text-center lg:text-left">
                    ...
                    <h2 class="text-3xl font-extrabold text-secondary-950 tracking-tight">Lupa Kata Sandi?</h2>
                    <p class="text-gray-500 mt-2 text-sm sm:text-base">Masukkan NIK Anda. Kami akan mengirimkan kode OTP via WhatsApp untuk mengatur ulang kata sandi.</p>
                </div>
                ...
                <div class="mt-8 text-center text-sm text-gray-600">
                    ...
                    <a href="{{ route('login') }}" class="font-bold text-primary-600 hover:text-primary-500 transition-colors ml-1">Masuk sekarang</a>
                </div>
            </div>
        </div>
    </div>
