...
<body class="font-sans antialiased bg-gray-50 text-gray-800 selection:bg-primary-500 selection:text-white flex flex-col min-h-screen">
    ...
    <a href="https://wa.me/6288226139635" target="_blank" rel="noopener noreferrer" class="fixed bottom-6 right-6 z-[100] group flex items-center justify-center bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl hover:shadow-[#25D366]/30 transition-all duration-300 overflow-hidden">
