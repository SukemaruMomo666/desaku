...
<body class="font-sans antialiased bg-gray-50 text-gray-800 selection:bg-primary-500 selection:text-white flex flex-col min-h-screen">
        ...
        <section class="py-24 bg-gray-50 relative overflow-hidden" id="informasi" x-data="{ activeModal: null }">
            ...
            <div x-show="activeModal === {{ $article->id }}" style="display: none;" class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                ...
                @if($isEmptyContent && $article->image)
                    <!-- Close Button -->
                    <button @click="activeModal = null; document.body.style.overflow = 'auto';" class="absolute top-4 right-4 md:top-6 md:right-6 z-[110] p-3 bg-black/50 hover:bg-black/80 backdrop-blur-md rounded-full text-white shadow-lg transition-all focus:outline-none border border-white/10">
                ...
                @else
                    ...
                    <div x-show="activeModal === {{ $article->id }}" 
                         ...
                         class="relative z-[105] w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div class="relative z-10 space-y-10">
                            ...
                            <div class="flex gap-6 group">
                                ...
                                <div class="pt-2">
                                    ...
                                    <p class="text-gray-900 text-lg font-bold">0895-1832-1220</p>
                                </div>
                            </div>
    ...
    <a href="https://wa.me/6289518321220" target="_blank" rel="noopener noreferrer" class="wa-button">
