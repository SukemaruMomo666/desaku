...
<body class="font-sans antialiased bg-gray-50 text-gray-800 selection:bg-primary-500 selection:text-white flex flex-col min-h-screen">
    ...
    <a href="https://wa.me/6288226139635" target="_blank" rel="noopener noreferrer" style="position: fixed; bottom: 2rem; right: 2rem; z-index: 9999;" class="group flex items-center justify-center bg-green-500 text-white rounded-full border-4 border-black shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
